    ...
    <div class="bg-pink text-white" style="margin: 0 auto !important; padding: 20px;">
        <form method="post">
            ...
            <div class="form-outline mb-4">
                ...
                <input type="text" id="form1Example3" class="form-control" name="serviceName"/>
            </div>

            <div class="form-outline mb-4">
                <label class="form-label" for="form1Example4">Service Area</label>
                <input type="text" id="form1Example4" class="form-control" name="serviceArea"/>
            </div>

            <div class="form-outline mb-4">
                <label class="form-label" for="form1Example5">Service Cost</label>
                <input type="text" id="form1Example5" class="form-control" name="serviceCost"/>
            </div>

            <div class="form-outline mb-4">
                <label class="form-label" for="form1Example6">Service Max People</label>
                <input type="text" id="form1Example6" class="form-control" name="serviceMaxPeople"/>
            </div>
            ...
            <div class="form-outline mb-4">
                ...
                <select class="form-select" aria-label="Default select example" id="form1Example8" name="serviceTypeId">
                    ...
                    <c:forEach items="${serviceTypes}" var="o">
                        <option value="${o.serviceTypeId}">${o.serviceTypeName}</option>
                    </c:forEach>
                </select>
            </div>
            ...
            <div class="form-outline mb-4">
                ...
                <input type="text" id="form1Example9" class="form-control" name="standardRoom"/>
            </div>

            <div class="form-outline mb-4">
                <label class="form-label" for="form1Example10">Description</label>
                <input type="text" id="form1Example10" class="form-control" name="descriptionOtherConvenience"/>
            </div>

            <div class="form-outline mb-4">
                <label class="form-label" for="form1Example11">Pool Area</label>
                <input type="text" id="form1Example11" class="form-control" name="poolArea"/>
            </div>

            <div class="form-outline mb-4">
                <label class="form-label" for="form1Example12">Number Of Floors</label>
                <input type="text" id="form1Example12" class="form-control" name="numberOfFloors"/>
            </div>
