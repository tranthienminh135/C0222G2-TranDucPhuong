...
!function (t, e) {
    ...
    const _n = "scrollspy", bn = {offset: 10, method: "auto", target: ""},
        ...
        wn = ".nav-link, .list-facility-group-item, .dropdown-item", En = "position";
    ...
    class An extends B {
        ...
        _activate(t) {
            ...
            i.classList.add(yn), i.classList.contains("dropdown-item") ? V.findOne(".dropdown-toggle", i.closest(".dropdown")).classList.add(yn) : V.parents(i, ".nav, .list-facility-group").forEach((t => {
                V.prev(t, ".nav-link, .list-facility-group-item").forEach((t => t.classList.add(yn))), V.prev(t, ".nav-item").forEach((t => {
    ...
    class xn extends B {
        ...
        show() {
            ...
            let t;
            const e = n(this._element), i = this._element.closest(".nav, .list-facility-group");
            if (i) {
    ...
    j.on(document, "click.bs.tab.data-api", '[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list-facility"]', (function (t) {
